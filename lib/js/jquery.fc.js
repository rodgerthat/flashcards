...
(function($) {
    ...
    // #todo - once the initial group of slides is loaded in, it may be necessary to stop the autoplay
    ...
    function resizeFlexWrap() {
        console.log("$window.width : " + $window.width() );
        console.log("$window.height : " + $window.height() );
        var $flexSliderWidth = $("#flexslider-1").outerWidth();
        var $flexSliderHeight = $("#flexslider-1").outerHeight();
        console.log("$flexSliderWidth : " + $flexSliderWidth);
        console.log("$flexSliderHeight : " + $flexSliderHeight);
//        console.log("$flexsliderDom.width : " + $flexsliderDom.width() );
//        console.log("$flexsliderDom.width : " + $flexsliderDom.width() );
    }

    $window.resize(resizeFlexWrap());

    // #todo - add a function to the window.resize event & buildSlider() to check for words that are too long, and bump the font down.

    // $todo - create slide randomizer function to ransomize slides on the fly, rather than making another request to the server
